...
func Test_AccountInfo(t *testing.T) {
	...
	for _, v := range []string{"0x2C35a52A51B742C3c1218e6c053059268c85BaB7","0xe2cD88bE7757921451A90A2A06df3831a2B38698"} {

		url := common.BuildUrlParam("http://127.0.0.1:3000/account/info", map[string]interface{}{
			"address": v,
		})
		body, err := common.HttpGet(url, map[string]string{}, 10)
		if err != nil {
